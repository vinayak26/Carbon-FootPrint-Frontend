...
export default class ScrollService {
  ...
  scrollToCalculate = () => {
    let CalculateScreen = document.getElementById("Calculate");
    if (!CalculateScreen) return;
    CalculateScreen.scrollIntoView({ behavior: "smooth" });
  };
  scrollToHome = () => {
  ...
  scrollToContactUs = () => {
    let ContactUsScreen = document.getElementById("ContactUs");
